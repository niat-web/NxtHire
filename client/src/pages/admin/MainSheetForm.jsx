...
const LocalInput = React.forwardRef(({ className, ...props }, ref) => (
    <input ref={ref} {...props} className={cn('w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-slate-900 text-sm disabled:bg-gray-100', className)} />
));
const LocalSelect = React.forwardRef(({ options, placeholder, className, ...props }, ref) => (
    <select ref={ref} {...props} className={cn('w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-slate-900 text-sm', className)}>
        {placeholder && <option value="">{placeholder}</option>}
        {options.map(opt => <option key={opt.value} value={opt.value}>{opt.label}</option>)}
    </select>
));
const LocalTextarea = React.forwardRef(({ className, ...props }, ref) => (
    <textarea ref={ref} {...props} className={cn('w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-slate-900 text-sm', className)} />
));
