  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-emerald-50 to-emerald-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 sm:p-10 border border-slate-200/50 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-600/5 via-indigo-600/5 to-emerald-600/5 -z-10"></div>
        
        <div className="text-center mb-8">
            <h1 className="text-3xl font-extrabold bg-gradient-to-r from-slate-800 via-emerald-800 to-emerald-800 bg-clip-text text-transparent">
              Set Your Password
            </h1>
