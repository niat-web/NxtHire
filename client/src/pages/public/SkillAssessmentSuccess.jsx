  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-20 w-40 h-40 bg-blue-200/10 rounded-full blur-2xl"></div>
      ...
      <div className="relative w-full max-w-md mx-auto">
        <div className="bg-white rounded-xl shadow-xl border border-white/50 p-6">
          {/* Success Icon */}
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl p-4 border border-blue-200/50">
              <p className="text-slate-700 text-sm leading-relaxed">
