...
const GuidelinesSubmissionSuccess = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-lg bg-white rounded-2xl border border-border p-10 text-center">
        ...
        <div className="my-8 text-left bg-muted/40 p-6 rounded-2xl border border-border">
          <p className="text-[10.5px] font-semibold text-muted-foreground uppercase tracking-[0.2em] mb-3">What's next</p>
          <ol className="list-decimal list-inside space-y-3 text-foreground/90 text-[13.5px] leading-relaxed">
            <li>
              <span className="font-semibold text-foreground">Under review —</span> Our team will now review your assessment results. This typically takes 1–2 business days.
            </li>
            <li>
              <span className="font-semibold text-foreground">Notification —</span> You will receive an email with the final decision and next steps. Please keep an eye on your inbox.
            </li>
          </ol>
        </div>
