  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 flex items-center justify-center">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute bottom-20 right-20 w-40 h-40 bg-blue-200/20 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-blue-200/20 rounded-full blur-2xl"></div>
      </div>

      <div className="relative w-full max-w-md mx-auto">
        <div className="bg-white rounded-xl shadow-xl p-8 border border-white/50">
          {/* Success Icon */}
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center relative">
              <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-4 rounded-full shadow-md">
          ...
          {/* Header */}
          <div className="text-center mb-6">
            <h1 className="text-2xl font-semibold mb-2 bg-gradient-to-r from-slate-800 to-blue-700 bg-clip-text text-transparent">
