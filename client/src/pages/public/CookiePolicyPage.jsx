  ...
  <div className="min-h-screen bg-white">
    ...
    <article className="max-w-3xl mx-auto px-5 lg:px-8 py-16 lg:py-20">
      ...
      <Section title="7. Contact us">
        <p>If you have questions about our use of cookies, please contact us at <a href="mailto:interviewercommunity@nxtwave.in" className="font-semibold text-slate-900 hover:text-[#FF4800] underline">interviewercommunity@nxtwave.in</a>.</p>
      </Section>
    </article>
  </div>
);
