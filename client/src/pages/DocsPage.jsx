...
const InfoBox = ({ children, title, icon }) => (
    <div className="my-6 p-4 bg-slate-50 border-l-4 border-blue-400 rounded-r-lg">
...
const Section = ({ id, title, icon, children }) => (
    <section id={id} className="mb-16 scroll-mt-24">
      <div className="flex items-center mb-6 pb-2 border-b-2 border-slate-200">
        {icon && <span className="text-slate-900 mr-3">{icon}</span>}
        <h2 className="font-display text-[30px] font-semibold text-slate-900 tracking-tight">{title}</h2>
      </div>
...
/>
            ...
            { id: 'support', title: 'Troubleshooting & Support', icon: <LifeBuoy />, level: 1, content: (
                <>
                    ...
                    <p>For any technical issues or questions not covered here, please contact our support team at <a href="mailto:interviewercommunity@nxtwave.in" className="font-semibold text-slate-900">interviewercommunity@nxtwave.in</a>.</p>
                </>
            )}
        ],
    };
