    ...
    <div className="animate-fade-in max-w-5xl mx-auto">
      ...
      <div className="mb-10">
        ...
        <div className="mt-3 flex items-center flex-wrap gap-x-6 gap-y-2 text-sm text-gray-600">
          ...
          <a href={applicant.linkedinProfileUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-slate-900 hover:text-blue-800 hover:underline">
