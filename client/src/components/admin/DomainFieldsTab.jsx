                                    ...
                                    {filteredDomains.map(domain => (
                                        <li key={domain.domainName}>
                                            <button type="button" onClick={() => { setSelectedDomain(domain); setSelectedParameter(null); }}
                                                className={cn('w-full text-left px-3 py-2 text-sm rounded-lg font-medium transition-colors', selectedDomain?.domainName === domain.domainName ? 'bg-muted/40 text-foreground' : 'text-gray-700 hover:bg-gray-100')}
                                            >
                                                {domain.domainName}
                                            </button>
                                        </li>
