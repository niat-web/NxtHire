...
const InitialApplicationForm = ({ onSuccess }) => {
  ...
  const iconCls =
    'absolute left-3 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-gray-400 group-focus-within:text-foreground transition-colors';
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <label className="flex items-start gap-3 cursor-pointer group">
          <input
            ...
            type="checkbox"
            className="mt-0.5 w-4 h-4 rounded border-gray-300 text-foreground focus:ring-primary/30 transition-all cursor-pointer"
