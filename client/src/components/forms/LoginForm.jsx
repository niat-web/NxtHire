...
// client/src/components/forms/LoginForm.jsx
import React, { useState } from 'react'; // <--- REMOVE: useRef, useEffect, createPortal
import { useNavigate, Link } from 'react-router-dom';
import { useForm } from 'react-hook-form';
import { useAuth } from '../../hooks/useAuth';
import { FiEye, FiEyeOff } from 'react-icons/fi';
// --- REMOVE: AnimatePresence and motion ---
// --- REMOVE: Alert component import ---

// --- MODIFICATION: Import useAlert ---
import { useAlert } from '../../hooks/useAlert';

const LoginForm = () => {
  const navigate = useNavigate();
  const { login } = useAuth();
  // --- MODIFICATION: Use the alert hook ---
  const { showError } = useAlert(); 
  
  // --- REMOVE: local alert state ---
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // --- MODIFICATION: Use showError from the hook ---
      showError(errorMessage);
      
      // --- REMOVE: setAlert and setTimeout ---
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  return (
    <>
      {/* --- REMOVE: The entire createPortal section --- */}
